 ...
 *
 * detectSale の実装は extension/shared/detect.js にあります（唯一の実装）。
...
// extension/shared/detect.js は CJS 形式で module.exports を公開しているため createRequire で読む
const require = createRequire(import.meta.url);
const { detectSale } = require('./extension/shared/detect.js');
